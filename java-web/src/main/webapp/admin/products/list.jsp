...
<script type="text/javascript">
	...
	function checkAll() {
		//获取全选
		var checkAll = document.getElementById("ckAllBook");

		// alert(checkAll.checked);

		var checkOne = document.getElementsByName("ckBookIds");
	...
	function deleteAllBook(){
		...
		//1.获取所有选中的书的进行拼接
		var chekedBooks = document.getElementsByName("ckBookIds");
		var books = '';
		for(var i =0;i<chekedBooks.length; i++){
			if(chekedBooks[i].checked){
				books = books + chekedBooks[i].value+',';
			}
		}
		...
		//3.调用Servlet方法删除图书
		if(books=='') return;
		location.href = '${pageContext.request.contextPath}/DeleteAllBooksServlet?ids='+books;
	}
</script>
</HEAD>
<body>
			...
			<TBODY>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									商品名称：</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text"
									name="name" size="15" value="" id="Form2_userName" class="bg" />
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									价格区间(元)：</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text"
				...
				<tr>
					<td class="ta_01" align="right">
						...
						<button type="button" id="add2" name="add" value="添加"
